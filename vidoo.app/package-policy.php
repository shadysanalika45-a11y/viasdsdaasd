...
<!-- Mirrored from vidoo.app/package-policy by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Nov 2025 12:15:17 GMT -->
...
<div class="container">
    <div>
        ...
        <h1 class="main-color-gradient">سياسة انتهاء صلاحية الحزم</h1>
        <p class="fw-bold">مرحباً بكم في فيدوو!</p>
        <p>نُقدّر ثقتكم بنا ونلتزم بتوفير تجربة مُرضية. تُوضح سياسة انتهاء صلاحية الحزم هذه كيفية التعامل مع انتهاء صلاحية الحزم والاشتراكات التي تشتريها من خلال منصة فيدوو.</p>
    </div>
    <div class="section-gap">

    <h3 class="sub-color-gradient">كيف تُحدّد صلاحية الحزمة؟</h3>
    <p>تُحدّد صلاحية الحزمة بناءً على نوع الحزمة والاشتراك الذي اشتريته. تُبين تفاصيل الاشتراك ومُدة صلاحيته بشكل واضح قبل إتمام الشراء.</p>

    </div>
    <div class="section-gap">

    <h3 class="sub-color-gradient">ما هو مصير الحزمة بعد انتهاء صلاحيتها؟</h3>
    <p>بعد انتهاء صلاحية الحزمة، لن تستطيع استخدام مزاياها والمُحتوى الذي تُقدّمه. قد نُقدّم لك إمكانية تجديد الاشتراك لضمان استمرار وصولك إلى مزايا الحزمة.</p>

    </div>
    <div class="section-gap">

    <h3 class="sub-color-gradient">هل يمكن استرداد الأموال بعد انتهاء صلاحية الحزمة؟</h3>
    <p>لا يُمكن استرداد الأموال بعد انتهاء صلاحية الحزمة. نُوصي بمراجعة مدة صلاحية الحزمة بعناية قبل الشراء وتجديد الاشتراك قبل انتهاء صلاحيته لضمان عدم فقدان مزايا الحزمة.</p>

    </div>

    <div class="note">
        <p>تُمكنك تحديد مدة صلاحية الحزمة في تفاصيل الاشتراك قبل الشراء.</p>
        <p>نُوصي بمراجعة تاريخ انتهاء صلاحية الحزمة بشكل منتظم لتجنب فقدان مزاياها.</p>
    </div>

    <h4 class="sub-color-gradient">اتصل بنا:</h4>
    <p>يمكنكم الاتصال بنا على [ذكر عنوان البريد الإلكتروني] أو [ذكر رقم الهاتف] إذا كانت لديكم أي أسئلة أو تعليقات حول سياسة انتهاء صلاحية الحزم هذه.</p>
