...
<!-- Mirrored from vidoo.app/forget-password by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Nov 2025 12:17:16 GMT -->
...
<head>
    ...
    <title>إعادة تعيين كلمة المرور - فيدوو</title>
    ...
    <link rel="apple-touch-icon" href="users-asset/images/logo/vidoo-1.png">
    <link rel="shortcut icon" type="image/x-icon" href="users-asset/images/logo/vidoo-1.png">
    ...
    <link rel="stylesheet" type="text/css"
        href="users-asset/css-rtl/core/menu/menu-types/horizontal-menu.css">
...
<!-- End Google Tag Manager -->
    ...
    <script src="users-asset/vendors/js/ui/jquery.sticky.js"></script>
    ...
    <!-- BEGIN: Page JS-->
    <script src="users-asset/js/scripts/pages/auth-forgot-password.js"></script>
    <!-- END: Page JS-->
...
<!-- Mirrored from vidoo.app/forget-password by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Nov 2025 12:17:17 GMT -->
</html>
